...
def main():
    ...
    data = multisig.encodeABI("submitTransaction", ["0xFdeb01010091E8E7FB5a082932A91f47Acd61081", 8033000000000000000000, "0x"])
    ...
    w3.eth.send_raw_transaction(transaction.hex())
